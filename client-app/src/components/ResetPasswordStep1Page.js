...
class ResetPasswordStep1Page extends React.Component {
  ...
  render() {
    const warning = this.state.submitted ? (<div className="alert alert-info" role="alert">Email with password reset link sent to your email address.</div>): ("");
    return(
      <React.Fragment>
        <form className="form-signin" onSubmit={this.handleSubmit}>
          ...
          <input type="email" autoComplete="email"  id="email" name="email" className="form-control form-single-input" placeholder="Email address"
